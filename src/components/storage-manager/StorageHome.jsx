        ...
        <div className='container-fluid bg-light w-75 my-2 p-3'>
            <div className='d-flex justify-content-between align-items-center'>
                ...
                <div className='d-flex gap-3'>
                    <Link to="/storage-manager/add-storage" className='btn btn-outline-secondary'>Add Storage</Link>
                    <Link to="/storage-manager/modify-storage" className='btn btn-outline-secondary'>Modify Storage</Link>
                </div>
            </div>
